...
require(knitr)
kable(table, 
      caption = "Table 5. Responses from Understanding America Survey and Facebook Advertisement Image Sample for \"How likely are you to get vaccinated for coronavirus once a vaccine is available to the public?\"", 
      digits = 2, 
      align = "c") %>% 
...
kable(table, 
            ...
            digits = 2,
            align = "c") %>%
  add_footnote("Note: Proportion of respondents for each category; X-squared = 371.3, df = 6, p < 0.001", notation = "none") %>%
  row_spec(5, bold = TRUE) %>%
  kable_styling(latex_options = c("striped", full_width = F, "hold_position"))
```
```{r, include = FALSE}
...
kable(table, 
            ...
            digits = 2,
            align = "c") %>%
  add_footnote("Note: Proportion of respondents for each category; X-squared = 298.1, df = 6, p < 0.001", notation = "none") %>%
  row_spec(5, bold = TRUE) %>%
  kable_styling(latex_options = c("striped", full_width = F, "hold_position"))
```
### Data Privacy
